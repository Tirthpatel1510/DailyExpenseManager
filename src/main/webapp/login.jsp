...
<html>
<head>
    <title>Login | DailyExpense</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.0/font/bootstrap-icons.css">
    <script src="https://accounts.google.com/gsi/client" async defer></script>
    <meta name="google-signin-client_id" content="145131493824-v5ticedsn6ddqjue97t7ss8nnnn0g3jb.apps.googleusercontent.com">
    <style>
            ...
            <div class="card p-4">
                <div class="card-body">
                    ...
                    <div class="text-center mt-4 small text-muted">
                        Don't have an account? <a href="register.jsp" class="text-decoration-none fw-bold">Create Account</a>
                    </div>
                </div>
            </div>
        </div>
